...
def process_data(testing_mode = false)
  if ARGV[0].nil?
...
def print_report(response_data)
...
def get_most_and_least_popular_product(orders, is_popular = true)
...
def get_median_order_value(orders)
...
def get_product_repurchased(orders)
